...
model = HMMv2(init_probability=ip, transition_probability=A, emission_probability=B, n_iter=20, tol=0.01)
...
# fit model parameters based on data
new_model = HMMv2(init_probability=ip_random, transition_probability=a_random, emission_probability=b_random, n_iter=100, tol=0.01)
new_model.fit(X)
print(new_model.ip)
print(new_model.a)
print(new_model.b)
print(new_model.score(X[0]))